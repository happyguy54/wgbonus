function processData() {
    ...
    let zemeHpid = lines[10] ? lines[10].match(/\d+/)[0] : '';
    let zemePerson = lines[10] ? lines[10].split('-')[1].trim().split(' ')[0] : '';
    let zemeRole = lines[10] ? lines[10].split('(')[1].split(')')[0] : '';
    ...
    let odHpid = lines[11] ? lines[11].match(/\d+/)[0] : '';
    let odPerson = lines[11] ? lines[11].split('-')[1].trim().split(' ')[0] : '';
    let odRole = lines[11] ? lines[11].split('(')[1].split(')')[0] : '';
